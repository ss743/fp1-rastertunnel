...
Aus den gefitteten Peaks lässt sich nun die Gitterkonstante bestimmen. Dazu benutzen wir folgende Formel, wobei $N$ die Anzahl der Peaks auf der verwendeten Linie ist: 
\begin{align*}
...
Innerhalb des Fehlers stimmen diese Werte überein. Durch die in REFREF beschriebene Begradigung der Bilder entstehen Verzerrungen im Bild, welche zu falschen Ergebnissen bei der Abstandsmessung führen können. Dadurch können sich Abweichungen bei der Gitterkonstante ergeben, die wir durch die Mittelung der erhaltenen Ergebnisse aus den verschiedenen Profillinien (siehe Kapitel \ref{begradigung}) versuchen auszugleichen.\\
